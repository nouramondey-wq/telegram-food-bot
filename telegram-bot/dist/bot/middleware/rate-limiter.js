...
exports.callbackRateLimiter = exports.commandRateLimiter = void 0;
...
const blockedUsers = new Map(); // userId -> unblock timestamp
    ...
    return async (ctx, next) => {
        ...
        if (unblockAt && now < unblockAt) {
            ...
            if (cfg.sendWarnings &&
                ...
                try {
                    await ctx.reply(`⚠️ أنت تتصل بسرعة كبيرة. الرجاء الانتظار ${remainingSeconds} ثانية.`);
                }
                catch {
        ...
        if (entry.count > cfg.maxRequests) {
            ...
            if (cfg.sendWarnings) {
                try {
                    await ctx.reply(`❌ تم حظرك مؤقتاً لمدة ${cfg.blockDurationMs / 1000} ثانية بسبب السرعة الزائدة. الرجاء الانتظار.`);
                }
                catch {
                    // Ignore send errors
                }
 ...
 */
exports.commandRateLimiter = rateLimiter({
    maxRequests: 5,
 ...
 */
exports.callbackRateLimiter = rateLimiter({
    maxRequests: 10,
