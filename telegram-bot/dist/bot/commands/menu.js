...
exports.setupMenuCommand = setupMenuCommand;
const menu_service_1 = require("../../services/menu_service");
...
function setupMenuCommand(bot) {
    bot.command('menu', async (ctx) => {
        ...
        try {
            ...
            // زر فتح الـ Mini App
            categoryButtons.push([
                { text: '🚀 فتح القائمة الكاملة', url: env_1.env.miniApp.url },
            ]);
    ...
    bot.action(/menu_cat_(.+)/, async (ctx) => {
